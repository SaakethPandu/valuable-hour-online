...
gdjs.Game_32SceneCode.GDChatInputObjects1= [];
gdjs.Game_32SceneCode.GDChatInputObjects2= [];
gdjs.Game_32SceneCode.GDChatInputObjects3= [];
gdjs.Game_32SceneCode.GDChatInputObjects4= [];
gdjs.Game_32SceneCode.GDChatInputObjects5= [];
gdjs.Game_32SceneCode.GDChatTextObjects1= [];
gdjs.Game_32SceneCode.GDChatTextObjects2= [];
gdjs.Game_32SceneCode.GDChatTextObjects3= [];
gdjs.Game_32SceneCode.GDChatTextObjects4= [];
gdjs.Game_32SceneCode.GDChatTextObjects5= [];
...
gdjs.Game_32SceneCode.GDScore2Objects5= [];
gdjs.Game_32SceneCode.GDHealthBarObjects1= [];
gdjs.Game_32SceneCode.GDHealthBarObjects2= [];
gdjs.Game_32SceneCode.GDHealthBarObjects3= [];
gdjs.Game_32SceneCode.GDHealthBarObjects4= [];
gdjs.Game_32SceneCode.GDHealthBarObjects5= [];
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20500140);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20507748);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20510716);
}
}
}
if (isConditionTrue_0) {
...
gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDArrowBarObjects4Objects = Hashtable.newFrom({"ArrowBar": gdjs.Game_32SceneCode.GDArrowBarObjects4});
...
gdjs.copyArray(runtimeScene.getObjects("ArrowBar"), gdjs.Game_32SceneCode.GDArrowBarObjects4);
/* Reuse gdjs.Game_32SceneCode.GDPlayerObjects4 */
{for(var i = 0, len = gdjs.Game_32SceneCode.GDPlayerObjects4.length ;i < len;++i) {
    ...
    gdjs.Game_32SceneCode.GDPlayerObjects4[i].getBehavior("Sticker").Stick(gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDArrowBarObjects4Objects, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.Game_32SceneCode.GDPlayerObjects4.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDPlayerObjects4[i].getBehavior("Health").Hit(50, true, true, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20516844);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20539300);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20540116);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("LeaveGameButton"), gdjs.Game_32SceneCode.GDLeaveGameButtonObjects2);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20541252);
}
}
if (isConditionTrue_0) {
...
gdjs.Game_32SceneCode.GDChatInputObjects1.length = 0;
gdjs.Game_32SceneCode.GDChatInputObjects2.length = 0;
gdjs.Game_32SceneCode.GDChatInputObjects3.length = 0;
gdjs.Game_32SceneCode.GDChatInputObjects4.length = 0;
gdjs.Game_32SceneCode.GDChatInputObjects5.length = 0;
gdjs.Game_32SceneCode.GDChatTextObjects1.length = 0;
gdjs.Game_32SceneCode.GDChatTextObjects2.length = 0;
gdjs.Game_32SceneCode.GDChatTextObjects3.length = 0;
gdjs.Game_32SceneCode.GDChatTextObjects4.length = 0;
gdjs.Game_32SceneCode.GDChatTextObjects5.length = 0;
...
gdjs.Game_32SceneCode.GDScore2Objects5.length = 0;
gdjs.Game_32SceneCode.GDHealthBarObjects1.length = 0;
gdjs.Game_32SceneCode.GDHealthBarObjects2.length = 0;
gdjs.Game_32SceneCode.GDHealthBarObjects3.length = 0;
gdjs.Game_32SceneCode.GDHealthBarObjects4.length = 0;
gdjs.Game_32SceneCode.GDHealthBarObjects5.length = 0;
